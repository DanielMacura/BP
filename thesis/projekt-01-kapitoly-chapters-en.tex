...
Humans use languges like English or Slovak every day to comunicate information, these languages are reffered to as \emph{natural languages}. \todo{sentance about a general definition of language from a dictionary} How ever a more riggorous definition of languges and the tools to operate on them is required. That is what the notion of formal language theory will introduce in the following sections.
...
The concept of a grammar is a powerfull tool for describing languages\cite[p. 52]{Linz2016Introduction}. A simple sentence in English consists of a single independent clause. A clause is typically formed by a subject and a predicate. This can be written as follows.
