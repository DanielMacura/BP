...
\projectinfo{
  ...
  title.en={Automatic translation and comparison of Lumerical and Meep simulations}, % název práce v angličtině / thesis title in english
  ...
  keywords.en={CEM, FDTD, Meep, Ansys Lumerical, Transpiler, Source-to-Source Compiler}, % klíčová slova v anglickém jazyce / keywords in english
  ...
  abstract.en={This thesis aims to provide a comparison between the Ansys Lumerical and Meep FTDT simulation tools. A self-designed transpiler from Lumerical Scripting Language to the Meep Python interface was implemented. FDTD simulation were first automaticaly  results are compared with analytical results.}, % abstrakt v anglickém jazyce / abstract in english
...
\begin{document}
  ...
  %\setglossarystyle{acronym}%superragged
